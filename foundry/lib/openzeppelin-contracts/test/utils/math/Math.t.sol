...
contract MathTest is Test {
    ...
    function _squareBigger(uint256 value, uint256 ref)
        private
        pure
        returns (bool)
    {
    ...
    function _squareSmaller(uint256 value, uint256 ref)
        private
        pure
        returns (bool)
    {
    ...
    function _powerOf2Bigger(uint256 value, uint256 ref)
        private
        pure
        returns (bool)
    {
    ...
    function _powerOf2Smaller(uint256 value, uint256 ref)
        private
        pure
        returns (bool)
    {
    ...
    function _powerOf10Bigger(uint256 value, uint256 ref)
        private
        pure
        returns (bool)
    {
    ...
    function _powerOf10Smaller(uint256 value, uint256 ref)
        private
        pure
        returns (bool)
    {
    ...
    function _powerOf256Bigger(uint256 value, uint256 ref)
        private
        pure
        returns (bool)
    {
    ...
    function _powerOf256Smaller(uint256 value, uint256 ref)
        private
        pure
        returns (bool)
    {
    ...
    function _mulHighLow(uint256 x, uint256 y)
        private
        pure
    ...
    function _addCarry(uint256 x, uint256 y)
        private
        pure
        returns (uint256 res, uint256 carry)
    {
        unchecked {
            res = x + y;
        }
