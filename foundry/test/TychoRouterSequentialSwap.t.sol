...
contract TychoRouterSequentialSwapTest is TychoRouterTestSetup {
        ...
        returns (bytes[] memory)
    {
        ...
        // Transfer directly from user to first pool
        ...
        swaps[0] = encodeSequentialSwap(
            ...
            encodeUniswapV2Swap(
                WETH_ADDR, WETH_DAI_POOL, tychoRouterAddr, false, transferNeeded
            )
        );
    ...
    function testSequentialSwapPermit2() public {
        ...
        tychoRouter.sequentialSwapPermit2(
            ...
            false,
            false,
            WETH_DAI_POOL, // in token receiver
            ALICE, // out token receiver
            permitSingle,
            signature,
            pleEncode(swaps)
        );
    ...
    function testSequentialSwapUnwrapETH() public {
        ...
        uint256 amountOut = tychoRouter.sequentialSwapPermit2(
            ...
            false,
            true,
            DAI_USDC_POOL, // in token receiver
            ALICE, // out token receiver
            permitSingle,
            signature,
            pleEncode(swaps)
