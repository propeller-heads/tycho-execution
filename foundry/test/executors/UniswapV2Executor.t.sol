...
contract UniswapV2ExecutorTest is UniswapV2ExecutorExposed, Test, Constants {
    ...
    function testAmountOut() public view {
        uint256 amountOut = uniswapV2Exposed.getAmountOut(
            WETH_DAI_POOL,
            10 ** 18,
            false
        );
    ...
    function testDecodeIntegration() public view {
        ...
        bytes
            memory protocolData = hex"c02aaa39b223fe8d0a0e5c4f27ead9083c756cc288e6a0c2ddd26feeb64f039a2c41296fcb3f5640000000000000000000000000000000000000000100";
    ...
    function testSwapIntegration() public {
        // Generated by the ExecutorStrategyEncoder - test_executor_strategy_encode
        bytes
            memory protocolData = hex"c02aaa39b223fe8d0a0e5c4f27ead9083c756cc2a478c2975ab1ea89e8196811f51a7b7ade33eb111d96f2f6bef1202e4ce1ff6dad0c2cb002861d3e00";
        uint256 amountIn = 10 ** 18;
        uint256 amountOut = 1847751195973566072891;
        deal(WETH_ADDR, address(uniswapV2Exposed), amountIn);
        uniswapV2Exposed.swap(amountIn, protocolData);
    ...
    function testComputePairAddress() public view {
        address computedPair = uniswapV2Exposed.computePairAddress(
            WETH_DAI_POOL
        );
        assertTrue(computedPair == WETH_DAI_POOL);
    }
    ...
    function testComputePairAddressInvalid() public {
        ...
        assertTrue(computedPair != maliciousPool);
    }
}
